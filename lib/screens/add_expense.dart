...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  void setUserId(String expenseId) {
    setState(() {
    ...
    if (formKey.currentState!.validate()) {
      setState(() {
        if (widget.isEdit) {
          ...
          ExpenseController().addExpense(widget.expenseModel, setUserId);
  ...
  void initState() {
    super.initState();
    setState(() {
      date = widget.expenseModel.expenseDate!.toDate();
    });
  }
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ButtonWidget(
                                onPressed: onSave,
                                title: "Save",
                                bgColor: const Color(0xFF5C7C7C),
                                borderColor: const Color(0xFF5C7C7C),
